        ...
        <div class="col-md-9 pr-3">
            ...
            <div class="container bg-white card content_info">
                ...
                <form id="form" class="form">
                    <!-- INFORMACION DE PAGO -->
                    <div id="formas-pago">
                        <div class="row  bg-light p-3 border-bottom border-top mb-3">
                            <div class="col-12 text-center">
                                <h3>@lang('informacion.forma_pago')</h3>
                            </div>
                        </div>
                        <div class="row mb-3">
                            <div class="col-12">
                    ...
                    <input type="hidden" id="forma_pago_tipo" name="forma_pago_tipo" value="">
                    <div class="row pb-4 pt-3">
                        <div class="col-12">
                            ...
                            <div class="field">
                                <div
                                    class=" mb-3 custom-control custom-checkbox text-center d-flex justify-content-center align-items-baseline">
                                ...
                                <div class="text-center">
                                    <a href="{{route('app.informacion',app()->getLocale(),false)}}"
                                       class="btn btn-primary btn-lg" id="pagar"
                                       type="button">@lang('informacion.regresar')</a>
        ...
        const FormaPago = function (serializado) {
            ...
            this.prepararCargo = function (parametros, success) {
                ...
                $.ajax({
                    ...
                    method: 'post',
                    data: {
                        forma_pago: Formulario.getTipoFormaPago(),
...
// informacionPago.pago_tarjeta().hide();
        ...
        const Formulario = {
            ...
            getTipoFormaPago: () => $("#forma_pago_tipo").val() || null,
            estaVacio: function () {
        ...
        $(document).ready(function () {
            // $("#payment-tarjeta").attr('checked', true);
...
// if (totalPagar > 0) $('#formas-pago input, #formas-pago select, #formas-pago textarea').prop('disabled', true);
            ...
            $("#form").validate({
                ...
                submitHandler: function (form) {
                    iniciarProceso();
                    const indice = Formulario.getTipoFormaPago();
