...
@section('content')
    <div class="contentMenu my-4">
        <div class="card rounded-0 border-0 shadow px-3" id="resumenReserva">
            <div class="row  bg-light border-bottom mb-3">
                <div class="col-md-12 d-flex justify-content-between py-4">
                    <a class="cursor-pointer" href="{{route('modificar.menu', app()->getLocale(),false)}}">
                        <i class="fa fa-3x fa-arrow-left color-acento float-left"></i>
                    </a>
                    <h3 class="text-center">@lang('modificar.resumen.titulo_reserva'): <span
                            class="font-weight-bold">{{ $reserva->folio }}</span></h3>
                    <button type="button" class="btn btn-primary" onclick="window.print();">
                        <i class="fa fa-2x fa-print float-right"></i>
                    </button>
                </div>
            </div>
            <div class="row ">
                ...
                <div class="col-md-4 mt-3 mt-md-0">
                    ...
                    <div class="row m-0 justify-content-between alert alert-secondary mt-2 mb-0">
                ...
                <div class="col-md-12 mt-4">
                    <div class="row m-0 justify-content-between">
                        <h4>@lang('email.detalle_habitacion')</h4>
                    </div>
                    <hr class="w-100 my-1">
                    <div class="row m-0 justify-content-between">
                ...
                <div class="col-md-12">
                    <div class="row m-0">
                        ...
                        <div class="col-4 col-md-2 text-right p-0 ">
            ...
            <div class="row mt-2 flex-column-reverse flex-md-row">
                <div class="col-md-6">
                    ...
                    <a class="cursor-pointer" data-toggle="modal" data-target="#modalInfoTarifa">
                        <h6>@lang('email.info_tarifa') <i class="fa fa-plus-circle"></i></h6></a>
                    <a class="cursor-pointer" data-toggle="modal" data-target="#modalPoliticaCondiciones">
                        <h6>@lang('email.info_politicas') <i class="fa fa-plus-circle"></i></h6>
                    </a>
                </div>
                <div class="col-md-6  ">
                    <div class="row m-0  alert alert-secondary pr-0 mb-0">
                        <div class="col-8 col-md-8 text-right">
                            <p>@lang('email.pago_garantia'):</p>
                            <p>@lang('email.saldo_hotel'):</p>
                        </div>
                        <div class="col-4 col-md-4 text-right pr-0">
                ...
                <div class="col-md-12 text-center">
                    ...
                    <form id="formSendReservation">
                        <div class="form-group row justify-content-center">
                            <label for="email" class="col-sm-2 col-form-label"> @lang('modificar.resumen.titulo_enviar')
                                : </label>
                            <div class="col-sm-6">
                        ...
                        <div class="col-md-12 mb-4">
                            <a href="{{route('modificar.menu', app()->getLocale(),false)}}" class="btn btn-secondary">
                            ...
                            <div class="mt-2">
                                <div class="alert alert-success d-none col-md-6 m-auto" role="alert">
                                    @lang('modificar.resumen.enviado')
                                </div>
                            </div>
                            <div class="mt-2">
                                <div class="alert alert-danger d-none col-md-6 m-auto" role="alert">
