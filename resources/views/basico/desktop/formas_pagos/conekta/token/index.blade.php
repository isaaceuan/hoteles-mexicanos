<div class="row">
    <div class="col-md-12">
            <div class="form-group row">
                ...
                <div class="col-sm-9">
                    <input type="text" id="propietario" class="form-control" name="propietario" required>
                </div>
            </div>
            <div class="form-group row">
                ...
                <div class="col-sm-2 float-left">
                    <select
                        ...
                        @for($anio = now()->year; $anio <= (now()->year + 8); $anio++)
                            <option
                                value="{{$anio}}" {{ old('expiracion-anio') == $anio ? 'selected' : '' }}>{{$anio}}</option>
                        @endfor
                    </select>
                </div>
            </div>
        <div class="text-right">
            <img src="/imagenes/logo_conekta_color.svg" alt="Conekta" width="150">
        </div>
    </div>
</div>
