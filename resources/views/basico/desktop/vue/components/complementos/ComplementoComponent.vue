    ...
    <section v-else>
        ...
        <div v-else>
            <div v-if="listaComplementos.length > 0 ">
                <template v-for="(complemento, idx) in listaComplementos">
                            ...
                            <div class="col-md-4">
                                <div class="thumb-container dialog-category w-100 imageOpenGalley"
                                    ...
                                    <div class="overlay-gallery">
                                        <i class="fa fa-info-circle fa-2x bg-acento-hover text-light p-2 rounded"></i>
                                    </div>
                                </div>
                            </div>
                            <div class="col-md-8 row pr-md-0">
                                <div class="d-flex align-items-center p-0" style="min-height: 60%">
                                    <div class="p-0">
                                ...
                                <div class="w-100">
                                    ...
                                    <p class="mb-0">
                                        <span class="border-bottom border-dark cursor-pointer"
                                              data-toggle="modal" data-target="#modalDetalleComplemento"
                                              v-on:click="verDetalleComplemento(complemento)"
                                        >{{$t('complemento.detalles')}}</span>
                                    </p>
                                </div>
                            </div>
<!--                            <div class="col d-flex align-items-center justify-content-center p-0">-->
<!--                                <div-->
<!--                                    class="text-center border-left px-4 h-75 d-flex align-items-center justify-content-center p-0">-->
...
<!--                                    </b-button>-->
<!--                                    <button type="button" class="btn btn-outline-danger addon-remove btn-block"-->
...
<!--                             :style="(indexOfComplementoSeleccionado(complemento.id) >= 0 ?'display:block;':'display:none')"-->
                            <div class="row bg-light py-1 border-bottom border-top">
                                <div class="col-md-12">
                                    <span
                                        class="text-uppercase font-weight-bold">{{$t('complemento.habitaciones')}}</span>
                                </div>
                            </div>
                            <div v-if="complemento.tipos_habitaciones.length > 0">
                                <div v-for="(habitacion) in complemento.tipos_habitaciones">
                                    <div class="row py-2 border-bottom reserva">
                                        <div class="col-md-8">
                                            <h6 class="font-weight-bold">{{$t('disponibilidad.habitacion')}}
                                                {{habitacion.indice}}:</h6>
                                            <h6 class="color-acento mb-0">
...
<script>
    ...
    import {carritoEvent, cambiarMonedaEvent, complementoEvent} from "../../app";
