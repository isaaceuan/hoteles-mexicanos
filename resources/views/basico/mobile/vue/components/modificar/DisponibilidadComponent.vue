<template>
    ...
    <section v-else>
        ...
        <div v-else class="mt-2 rounded-0 border-0 shadow-sm">
            <div v-if="existe_disponibilidad">
                <modificar-tarifa-habitacion-component
                    v-if="por_tarifa"
                    :datos="datos"
                    :tiene_elementos="tiene_elementos"
                    :propiedad="propiedad"
                    :color="color_cargador">
                </modificar-tarifa-habitacion-component>
                <modificar-habitacion-tarifa-component
                    v-else
                    :datos="datos"
                    :tiene_elementos="tiene_elementos"
                    :color="color_cargador"
