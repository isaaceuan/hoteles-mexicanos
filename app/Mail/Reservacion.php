...
class Reservacion extends Mailable
{
    ...
    public function build()
    {
        ...
        switch ($this->_tipoReservacion) {
            case 'Nuevo':
                $tituloCorreo = __('email.su_reservacion');
                $plantilla = 'plantilla.reserva_nueva';
                break;
            case 'Modificado':
                $tituloCorreo = __('email.su_reservacion_modificada');
                $plantilla = 'plantilla.reserva_modificada';
                break;
            case 'Cancelado':
                $tituloCorreo = __('email.su_reservacion_cancelada');
                $plantilla = 'plantilla.reserva_cancelada';
                break;
        }
